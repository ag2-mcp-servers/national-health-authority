...
class CertificateParameters(BaseModel):
    ...
    UDF1: str = Field(..., description='PMJAY ID', examples=['PMJAY0000'])
    UDF2: str = Field(
        ...,
        description='State Name',
        examples=[
            'JAMMU AND KASHMIR,HIMACHAL PRADESH,PUNJAB,CHANDIGARH,UTTARAKHAND,HARYANA,DELHI,RAJASTHAN,UTTAR PRADE'
        ],
    )
...
class PmjayCertificatePostRequest(BaseModel):
...
class PmjayCertificatePostResponse(BaseModel):
...
class PmjayCertificatePostResponse1(BaseModel):
...
class PmjayCertificatePostResponse2(BaseModel):
...
class PmjayCertificatePostResponse3(BaseModel):
...
class PmjayCertificatePostResponse4(BaseModel):
...
class PmjayCertificatePostResponse5(BaseModel):
...
class PmjayCertificatePostResponse6(BaseModel):
